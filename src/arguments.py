...
def common_parser():
    ...
    parser.add_argument("--metric_embedding_dim", type=int, default=4902, help='dimensionality of the embedding feture vector used for the contrastive loss learning')
